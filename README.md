...
11. **Added improved level select menu.** The level select cards show a preview of the bubble grid, and also the highscore of the player for that particular level.
