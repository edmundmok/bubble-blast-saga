 ...
 */
class LevelDesignerDataSource: NSObject {
...
extension LevelDesignerDataSource: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BubbleCell.Constants.identifier, for: indexPath)
